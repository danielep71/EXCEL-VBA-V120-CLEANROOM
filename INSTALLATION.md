...
### Install, validate, upgrade, troubleshoot, and remove Excel VBA v1.2.0 Cleanroom
...
This repository is currently rendered for the **library** profile.
...
```text
git clone https://github.com/danielep71/EXCEL-VBA-V120-CLEANROOM.git
